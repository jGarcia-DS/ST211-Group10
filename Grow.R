...
dat.grow$W1wrk1aMP <- with(dat.grow, Recode(W1wrk1aMP, "c(1,3) = 'FullTime'"))
dat.grow$W1wrk1aMP <- with(dat.grow, Recode(W1wrk1aMP, "c(2,4) = 'PartTime'"))
dat.grow$W1wrk1aMP <- with(dat.grow, Recode(W1wrk1aMP,"c(10) = 'LookingAfterFamily'"))
dat.grow$W1wrk1aMP <- with(dat.grow, Recode(W1wrk1aMP,"c(5,6,7,8,9,11,12) = 'Other'"))
dat.grow$W1wrk1aMP<-relevel(dat.grow$W1wrk1aMP,ref="FullTime")
...
dat.grow$W1hous12HH <- with(dat.grow, Recode(W1hous12HH, "c(1,2,3) = 'Owned/Mortgage'"))
dat.grow$W1hous12HH <- with(dat.grow, Recode(W1hous12HH, "c(4,5,6) = 'Rent'"))
dat.grow$W1hous12HH <- with(dat.grow, Recode(W1hous12HH, "c(7,8) = 'Other'"))
dat.grow$W1hous12HH<-relevel(dat.grow$W1hous12HH,ref='Owned/Mortgage')

# Didn't merge usevc

dat.grow$W1hiqualdad <- with(dat.grow, Recode(W1hiqualdad, "c(1,2,3) = 'HigherDegree'"))
dat.grow$W1hiqualdad <- with(dat.grow, Recode(W1hiqualdad, "c(7,11,12) = 'A-Levels or Equivalent'"))
dat.grow$W1hiqualdad <- with(dat.grow, Recode(W1hiqualdad, "c(15,16) = 'GCSE'"))
dat.grow$W1hiqualdad <- with(dat.grow, Recode(W1hiqualdad, "c(20) = 'None'"))
dat.grow$W1hiqualdad <- with(dat.grow, Recode(W1hiqualdad, "c(4,5,6,8,9,10,13,14,17,18,19) = 'Other'"))
dat.grow$W1hiqualdad<-relevel(dat.grow$W1hiqualdad,ref='None')
...
dat.grow$W1empsdad <- with(dat.grow, Recode(W1empsdad, "c(1,2) = 'PaidWork'"))
dat.grow$W1empsdad <- with(dat.grow, Recode(W1empsdad, "c(3) = 'Unemployed'"))
dat.grow$W1empsdad <- with(dat.grow, Recode(W1empsdad, "c(7) = 'Retired'"))
dat.grow$W1empsdad <- with(dat.grow, Recode(W1empsdad, "c(8) = 'Sick/Disabled'"))
dat.grow$W1empsdad <- with(dat.grow, Recode(W1empsdad, "c(4,5,6,9) = 'Other'"))
dat.grow$W1empsdad<-relevel(dat.grow$W1empsdad,ref='PaidWork')

# W1ch0_2HH not changing
...
dat.grow$W1ch12_15HH <- with(dat.grow, Recode(W1ch12_15HH, "c(0,1) = '0-1'"))
dat.grow$W1ch12_15HH <- with(dat.grow, Recode(W1ch12_15HH, "c(2,3,4) = '>1'"))
dat.grow$W1ch12_15HH<-relevel(dat.grow$W1ch12_15HH,ref='0-1')

# W1ch16_17HH not changing

# W1IndSchool not changing

dat.grow$W1marstatmum <- with(dat.grow, Recode(W1marstatmum, "c(1) = 'Single'"))
dat.grow$W1marstatmum <- with(dat.grow, Recode(W1marstatmum, "c(2,4) = 'Married'"))
dat.grow$W1marstatmum <- with(dat.grow, Recode(W1marstatmum, "c(5) = 'Divorced'"))
dat.grow$W1marstatmum <- with(dat.grow, Recode(W1marstatmum, "c(3,6,7) = 'Other'"))
dat.grow$W1marstatmum<-relevel(dat.grow$W1marstatmum,ref='Married')

dat.grow$W1nssecfam <- with(dat.grow, Recode(W1nssecfam, "c(1,2) = 'Managerial/Professional'"))
dat.grow$W1nssecfam <- with(dat.grow, Recode(W1nssecfam, "c(3,4) = 'Intermediate'"))
dat.grow$W1nssecfam <- with(dat.grow, Recode(W1nssecfam, "c(8) = 'Never worked/long term unemployed'"))
dat.grow$W1nssecfam <- with(dat.grow, Recode(W1nssecfam, "c(5,6,7) = 'Other'"))
dat.grow$W1nssecfam<-relevel(dat.grow$W1nssecfam,ref='Managerial/Professional')
...
# CAN ADD BACK IN AT THE END (the columns with only 1 level after the missing data) TO SEE THE DIFFERENCE
