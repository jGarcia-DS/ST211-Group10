...
dat.pusa$W1hous12HH <- with(dat.pusa, Recode(W1hous12HH, "c(1,2,3) = 'Owned/Mortgage'"))
dat.pusa$W1hous12HH <- with(dat.pusa, Recode(W1hous12HH, "c(4,5,6) = 'Rent'"))
dat.pusa$W1hous12HH <- with(dat.pusa, Recode(W1hous12HH, "c(7,8) = 'Other'"))
dat.pusa$W1hous12HH<-relevel(dat.pusa$W1hous12HH,ref='Owned/Mortgage')

dat.pusa$W1hiqualmum <- with(dat.pusa, Recode(W1hiqualmum, "c(1,2,3) = 'HigherDegree'"))
dat.pusa$W1hiqualmum <- with(dat.pusa, Recode(W1hiqualmum, "c(7,11,12) = 'A-Levels or Equivalent'"))
dat.pusa$W1hiqualmum <- with(dat.pusa, Recode(W1hiqualmum, "c(15,16) = 'GCSE'"))
dat.pusa$W1hiqualmum <- with(dat.pusa, Recode(W1hiqualmum, "c(20) = 'None'"))
dat.pusa$W1hiqualmum <- with(dat.pusa, Recode(W1hiqualmum, "c(4,5,6,8,9,10,13,14,17,18,19) = 'Other'"))
dat.pusa$W1hiqualmum<-relevel(dat.pusa$W1hiqualmum,ref='None')
...
dat.pusa$W1marstatmum <- with(dat.pusa, Recode(W1marstatmum, "c(1) = 'Single'"))
dat.pusa$W1marstatmum <- with(dat.pusa, Recode(W1marstatmum, "c(2,4) = 'Married'"))
dat.pusa$W1marstatmum <- with(dat.pusa, Recode(W1marstatmum, "c(5) = 'Divorced'"))
dat.pusa$W1marstatmum <- with(dat.pusa, Recode(W1marstatmum, "c(3,6,7) = 'Other'"))
dat.pusa$W1marstatmum<-relevel(dat.pusa$W1marstatmum,ref='Married')

dat.pusa$W1nssecfam <- with(dat.pusa, Recode(W1nssecfam, "c(1,2) = 'Managerial/Professional'"))
dat.pusa$W1nssecfam <- with(dat.pusa, Recode(W1nssecfam, "c(3,4) = 'Intermediate'"))
dat.pusa$W1nssecfam <- with(dat.pusa, Recode(W1nssecfam, "c(8) = 'Never worked/long term unemployed'"))
dat.pusa$W1nssecfam <- with(dat.pusa, Recode(W1nssecfam, "c(5,6,7) = 'Other'"))
dat.pusa$W1nssecfam<-relevel(dat.pusa$W1nssecfam,ref='Managerial/Professional')
...
dat.pusa$W6acqno <- with(dat.pusa, Recode(W6acqno, "c(1,2) = 'DegreeHE'"))
dat.pusa$W6acqno <- with(dat.pusa, Recode(W6acqno, "c(3,4) = 'A-levels'"))
dat.pusa$W6acqno <- with(dat.pusa, Recode(W6acqno,"c(5,6) = 'GCSE'"))
dat.pusa$W6acqno <- with(dat.pusa, Recode(W6acqno,"c(7,8,9) = 'Other'"))
...
dat.pusa$W8DACTIVITYC <- with(dat.pusa, Recode(W8DACTIVITYC, "c(1,2) = 'Employed'"))
dat.pusa$W8DACTIVITYC <- with(dat.pusa, Recode(W8DACTIVITYC, "c(4) = 'Unemployed'"))
dat.pusa$W8DACTIVITYC <- with(dat.pusa, Recode(W8DACTIVITYC, "c(3,5,6,7,8,10) = 'Other'"))
...
dat.pusa$W8TENURE <- with(dat.pusa, Recode(W8TENURE, "c(1,2,3) = 'Own'"))
dat.pusa$W8TENURE <- with(dat.pusa, Recode(W8TENURE, "c(4) = 'Rent'"))
dat.pusa$W8TENURE <- with(dat.pusa, Recode(W8TENURE, "c(5) = 'RentFree'"))
dat.pusa$W8TENURE <- with(dat.pusa, Recode(W8TENURE, "c(7) = 'Other'"))
